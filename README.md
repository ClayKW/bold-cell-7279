...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/bold-cell-7279)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bold-cell-7279
```

A live public deployment of this template is available at [https://bold-cell-7279.templates.workers.dev](https://bold-cell-7279.templates.workers.dev)
